...
## Goal
A playable **web build** of The Legend of Zelda: Ocarina of Time, built from the community decomp, where **every asset the decomp extracts from the ROM is regenerated** (clean room), published as `andrewnakas/oot-cleanroom` + GitHub Pages. Same result as Super Mario 64 (https://andrewnakas.github.io/sm64-cleanroom/) and Pilotwings 64.
...
- Work dirs: `C:/Users/andre/n64work/oot/` (pristine, dirty, clean, build). **E: is nearly full**: build on C:. emsdk: `E:/n64web/emsdk` (EM_CACHE=E:/n64web/emcache).
...
## ROM / decomp
- ROM: C:/Users/andre/Downloads/Legend of Zelda, The - Ocarina of Time (USA) (Rev 2).zip (NTSC 1.2; unzip first)
- Decomp: https://github.com/zeldaret/oot
